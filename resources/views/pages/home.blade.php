    ...
    <section class="home ">
        ...
        <div class="mx-0 xl:h-screen mt-5">
            <div class="grid grid-cols-1 md:grid-cols-2 gap-3">
                <div>
                    <img src="{{ asset('images/home_section.png') }}" class="" alt="">
                </div>
                <div class="flex items-center text-center md:text-right">
                    <div class="">
                        <button
                            class="text-primary text-sm lg:text-base mb-2 outline outline-1 outline-primary rounded-full px-3 lg:px-6 py-1 lg:py-2 tracking-wide font-bold">View
                            our services and apps</button>
                        <h1 class="text-xl lg:text-6xl font-bold ">Your <span class="text-primary">All in One</span>
                        </h1>
                        <h1 class="text-xl lg:text-6xl font-bold mb-3">IT Solutions</h1>
        ...
        <div class="mx-10 xl:h-screen mt-20  ">
            <div class="grid grid-cols-1 lg:grid-cols-2 gap-10">
                <div class="relative">
                    ...
                    <img src="{{ asset('images/smart-life.png') }}" class="absolute top-32 w-[530px] h-[370px] left-10"
                        alt="">
                ...
                <div class="swiper-wrapper">
                    <div class="swiper-slide">
                        <div class="col-span-1 relative group">
                            ...
                            <div
                                class="w-4/5 fast-move group-hover:-translate-y-20 group-hover:duration-300 bg-primary h-[100px] absolute -bottom-12 left-[10%]  z-50  mx-auto ">
                                <div class="px-4 py-2">
                                    <h1 class="text-white text-sm  lg:text-xl mb-1 ">
                                        Fast move Distribution Software
                                    </h1>
                                    <h1 class=" text-xs lg:text-sm text-gray-200">Lorem ipsum dolor sit amet consectetur
                                        adipisicing elit.</h1>
                                </div>
                            </div>
                        </div>
        ...
        <div class="bg-[#DEFFD8] mb-10">
            <div class="text-center py-10">
                ...
                <h1 class="text-[#797979] text-xs lg:text-sm">We provide anything you could ask for- uniquely end-to-end
