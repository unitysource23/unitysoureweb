        ...
        <section class="home ">
            ...
            <div class="mx-10 xl:h-screen mt-20  ">
                <div class="grid grid-cols-1 lg:grid-cols-2 gap-10">
                    <div class="relative">
                        ...
                        <img src="{{ asset('images/Frame.png') }}" class="absolute w-[1300px] top-0 " alt="">
                    </div>
                    <div class="flex items-center">
                        <div>
                            <h1 class="font-bold text-lg lg:text-2xl">Smart Life</h1>
                        <h1 class="font-semibold text-primary text-base lg:text-xl mb-5">Hire Purchase Services</h1>
                        ...
                        <a href="" class="text-primary font-semibold">Fint Out More <i class="fa-solid fa-arrow-right-long ml-2"></i></a>
                        </div>

                    </div>
                </div>
                {{--  <div class="grid grid-cols-1 lg:grid-cols-2 gap-10">
                    <div class="lg:col-span-1 mx-5 relative -z-50">
                        <img src="{{ asset('images/Ellipse 12.png') }}" class="w-[500px] mx-auto lg:m-0"
                            alt="">
                    </div>
                    <div class="lg:col-span-1 mx-5 lg:mx-0 flex items-center justify-center">
                        <div class="">
                            <h1 class="font-bold text-xl lg:text-3xl">Smart Life</h1>
                            <h1 class="text-primary text-md lg:text-xl font-semibold mb-5">Hire Purchases Services
                            </h1>
                            <h1 class="text-paraColor text-sm md:text-base text-justify mb-5">Lorem ipsum dolor sit
                                amet consectetur
                                adipisicing elit. Quis rem labore enim, atque earum consequuntur nulla quos eaque
                                magnam
                                harum dicta veritatis dignissimos quaerat laudantium quisquam delectus incidunt
                                consequatur laborum.
                                Odit, tempora corrupti? Quam veniam tenetur laudantium reiciendis doloremque quidem!
                                Atque ex eos reprehenderit commodi ea. Ab excepturi aut ad, labore eaque aspernatur,
                                libero dolorem molestias deleniti fugiat minima unde?
                                Odit labore eaque porro laborum qui quas quasi dignissimos praesentium voluptatum
                                enim,
                                inventore officia id aut iure earum dolorum sit quos ea! Vel dolorum exercitationem
                                itaque doloremque reiciendis delectus ea.\</h1>
            ...
            {{--  <div class="container mx-auto">
                <div class="grid grid-cols-1 lg:grid-cols-2 gap-2  ">
                    <div class="text-right mx-5 lg:mx-0 flex items-center">
                        <div>
                            <h1 class="font-bold text-lg lg:text-3xl">Fast Move</h1>
                            <h1 class="text-primary text-lg lg:text-xl font-semibold mb-5 ">Distribution System
                                Software</h1>
                            <h1 class="text-paraColor text-sm md:text-base ">
                                Our Software is a tool that enables businesses to efficiently manage their supply
                                chain
                                operations. It assists in automating tasks like inventory tracking, order
                                processing,
                                and logistics management. This software enhances the distribution process by
                                optimizing
                                inventory levels, minimizing order fulfillment time, and improving overall
                                operational
                            ...
                            <a href="" class="text-primary  font-semibold"><i
                                    class="fa-solid fa-arrow-left-long mr-2"></i>Find Out More </i></a>
                        </div>
